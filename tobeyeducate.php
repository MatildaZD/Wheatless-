...
<script>
 ...
 gtag('js', new Date());  gtag('config', 'G-LDLB94KCY8');
    ...
    <body>
	 ...
	 <div class="dropdown">
        <br>
          <a href="https://wheatless.riverdale.edu/restaurants.php" class="button-wrapper">
...
<!-- MATILDA MAKE THE SEARCH BAR HERE I THINK -->

<div class="flexarticle">
<span id="description">Wow, this is a paragraph I am using to test the styling. That is so cool. I am so cool.</span>
<div class="flexarticle">
wowowwoowow
</div>
</div>
